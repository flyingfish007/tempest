...
VsmGroup = [
    ...
    cfg.StrOpt('vsm_controller_ip',
               default="192.168.7.47",
               help="The floating ip of controller"),
    cfg.ListOpt('vsm_agents_ip',
               default=["192.168.7.48", "192.168.7.49",
                        "192.168.7.50", "192.168.7.51"],
               help="The floating ip of agents"),
