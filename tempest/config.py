...
VsmGroup = [
    ...
    cfg.ListOpt('volumes_name',
                default=["test-volume1", "test-volume2", "test-volume3",
                         "test-volume4", "test-volume5", "test-volume6"],
                help="The list of volumes name"),
    cfg.ListOpt('volumes_name_extensions',
                default=["test-volume7", "test-volume8"],
                help="The list of volumes name to extend"),
    cfg.IntOpt('osd_count',
               default=1,
               help="The count of osd on each vsm storage agent."),
    ...
    cfg.ListOpt('agent_servers_name',
                default=["test-node1", "test-node2",
                         "test-node3"],
                help="The list of vsm agent servers name"),
    cfg.ListOpt('agent_servers_name_extensions',
                default=["test-node4"],
                help="The list of vsm agent servers name to extend"),
    cfg.StrOpt('controller_server_name',
               default="test-controller",
               help="The vsm controller server name."),
    cfg.StrOpt('floating_ip',
               default="192.168.7.61",
               help="The floating ip of vsm"),
    ...
    cfg.StrOpt('ssh_username',
               default="intel",
               help="The user name to login vm"),
