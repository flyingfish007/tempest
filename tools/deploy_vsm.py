...
from apply_servers import ApplyServers, error
...
def deploy_vsm():
    ...
    os.system("echo \"token-tenant\"| tee -a %s" % server_manifest_example_path)
    os.system("echo \"\"| tee -a %s" % server_manifest_example_path)
    ...
    os.system("echo \"\"| tee -a %s" % server_manifest_example_path)
    os.system("echo \"[7200_rpm_sata]\"| tee -a %s" % server_manifest_example_path)
    os.system("echo \"#format [sata_device]  [journal_device]\"| tee -a %s" %
              server_manifest_example_path)
    os.system("echo \"\"| tee -a %s" % server_manifest_example_path)
    os.system("echo \"[10krpm_sas]\"| tee -a %s" % server_manifest_example_path)
    os.system("echo \"#format [sas_device]  [journal_device]\"| tee -a %s" %
              server_manifest_example_path)
    os.system("echo \"/dev/vdb1  /dev/vdc1\"| tee -a %s" % server_manifest_example_path)
